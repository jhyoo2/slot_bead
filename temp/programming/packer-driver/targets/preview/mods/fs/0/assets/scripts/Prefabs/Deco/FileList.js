System.register(["__unresolved_0", "cc"], function (_export, _context2) {
  ...
  function _reportPossibleCrUseOfFileTitle(extras) {
    _reporterNs.report("FileTitle", "./FileTitle", _context2.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "30a70+WqNVObIHJ9CK5ifJX", "FileList", undefined);

      ccclass = _decorator.ccclass;
      property = _decorator.property;

      _export("default", FileList = (_dec = ccclass("FileList"), _dec2 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
