System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context2) {
  ...
  function _reportPossibleCrUseOfCCUtils(extras) {
    _reporterNs.report("CCUtils", "../../Common/CCUtils", _context2.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", RoomBlock = (_dec = ccclass("RoomBlock"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        _proto.activateBlock = function activateBlock() {
          ...
          tween(this.outerObject).tag(108).call(function () {
            (_crd && CCUtils === void 0 ? (_reportPossibleCrUseOfCCUtils({
              error: Error()
            }), CCUtils) : CCUtils).fadeIn(_this2.outerObject, 0.2);
          }).delay(1.0).call(function () {
            (_crd && CCUtils === void 0 ? (_reportPossibleCrUseOfCCUtils({
              error: Error()
            }), CCUtils) : CCUtils).fadeOut(_this2.outerObject, 1);
          }).start();
        };
        ...
        _proto.deActivateBlock = function deActivateBlock() {
          ...
          tween(this.outerObject).call(function () {
            (_crd && CCUtils === void 0 ? (_reportPossibleCrUseOfCCUtils({
              error: Error()
            }), CCUtils) : CCUtils).fadeOut(_this3.outerObject, 0.01);
          }).start();
        };
