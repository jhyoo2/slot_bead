System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, Vec3, color, Sprite, UITransformComponent, Size, instantiate, AssetManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, FileTitle;
  ...
  function _reportPossibleCrUseOfFileList(extras) {
    _reporterNs.report("FileList", "./FileList", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "867b2PaF1VLNJ2FGg0qLeXW", "FileTitle", undefined);
      ...
      _export("default", FileTitle = (_dec = ccclass("FileTitle"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = (_temp = class FileTitle extends Component {
        ...
        setFileData(fileDatas) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            const fileList = fileListNode.getComponent("FileList");
...
//# sourceMappingURL=FileTitle.js.map